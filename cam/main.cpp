...
int main() {
	...
	//	audio.initAudio();
...

		{
			...
			std::shared_ptr<Component> aiMesh(new Mesh(std::unique_ptr<Shader>(new ModelShader("runner_texture_blue.jpg")), "chaser_mesh.fbx", vec3(1.0, 0.84, 0.0), vec3(4.427f, 2.426f, 12.935f), GL_TRIANGLES));
